...
public class CustomAdapterProductFromPlayStore extends BaseAdapter {
    ...
    public CustomAdapterProductFromPlayStore(AppCompatActivity appCompatActivity, List<SkuDetails> skuDetailsList, BillingClient billingClient) {

        this.appCompatActivity = appCompatActivity;
        this.skuDetailsList = skuDetailsList;
        this.billingClient = billingClient;
        mDataBaseRef = new FireBaseHelper(appCompatActivity);
    ...
    public Object getItem(int position) {
        mDataBaseRef.ShowLog("list position is"+ skuDetailsList.get(position));
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        CustomAdapterProductFromPlayStore.ViewHolder holder;
        ...
        if (convertView == null) {
            ...
            mDataBaseRef.ShowLog("Veiw inflated");
            ...
            holder = (CustomAdapterProductFromPlayStore.ViewHolder) convertView.getTag();
        }
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
            holder.productsCoins.setTextColor(appCompatActivity.getColor(R.color.Ext_primary_text));
        }
        ...
        holder.btnBuy.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Toast.makeText(appCompatActivity, "Msg is: "+ skuDetailsList.get(position).getTitle(), Toast.LENGTH_SHORT).show();
                ...
                switch (response){
                    ...
                    case BillingClient.BillingResponseCode.OK:
                        ...
                        //TODO: Add shared prefrence to check new purchase flow.
                        break;
